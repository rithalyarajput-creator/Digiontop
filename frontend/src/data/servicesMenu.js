...
export const SERVICES_MENU = [
  ...
  },
  {
    ...
    items: [
      { label: 'Mobile App Development', path: '/services/mobile-software' },
      { label: 'iOS App Development', path: '/services/mobile-software' },
      { label: 'Android App Development', path: '/services/mobile-software' },
      { label: 'Flutter App Development', path: '/services/mobile-software' },
      { label: 'Cloud Solutions', path: '/services/mobile-software' },
      { label: 'API Development', path: '/services/mobile-software' },
      { label: 'SaaS Development', path: '/services/mobile-software' },
      { label: 'DevOps Services', path: '/services/mobile-software' },
    ],
  },
  {
