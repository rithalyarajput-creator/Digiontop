...
const HeroSection = () => (
  <section className="hero hero--banner">
    {/* Full banner image — shown complete (never cropped). Text/CTA live inside the image. */}
    <a href="/contact" className="hero__banner-link" aria-label="DigionTop — Get a free consultation">
      <img src="/images/home-banner.png" alt="DigionTop — #1 Digital Marketing Agency. Get a free strategy call." className="hero__banner-full" />
    </a>
  </section>
);
